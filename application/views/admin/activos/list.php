    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12">  
                        <a href="<?php echo base_url();?>almacen/activos/add" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Agregar Activo</a>
                    </div>
                </div>
                <hr>
                <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <?php if($activo->estado): ?>
                                                    <a href="<?php echo base_url();?>almacen/activos/delete/<?php echo $activo->id;?>" class="btn btn-danger btn-remove"><span class="fa fa-remove"></span></a>
                                                     <?php else :?>
                                                    <a href="<?php echo base_url();?>almacen/activos/restore/<?php echo $activo->id;?>" class="btn btn-success btn-check"><span class="fa fa-check"></span></a>
                                                    <?php endif;?>
