            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                                    ...
                                    <input type="text" name="comprobante" class="form-control" placeholder="Escriba el Tipo de Comprobante">

                                    <label for="">Serie:</label>
                                    <input type="text" class="form-control" id="serie" name="serie" placeholder="Escriba el No. de Serie">
                                    ...
                                    <input type="text" class="form-control"  name="proveedor" id="proveedor" placeholder="Escriba aqui el nombre del Proveedor" required>
