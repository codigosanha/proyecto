                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group <?php echo !empty(form_error('cod_barras')) ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="cod_barras" name="cod_barras" required value="<?php echo set_value('cod_barras')?:$producto->cod_barras;?>">
                               </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="descripcion" name="descripcion" required="required" value="<?php echo $producto->descripcion;?>">
                            </div>
