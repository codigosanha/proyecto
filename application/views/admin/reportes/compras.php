                                ...
                                <?php if (!empty($compras)): ?>
                                    <?php foreach($compras as $compra):?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-info btn-info-compra" value="<?php echo $compra->id;?>" data-toggle="modal" data-target="#modal-compra"><span class="fa fa-search"></span></button>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
                                <?php endif ?>
